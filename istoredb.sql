...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2024 at 10:31 AM
...
CREATE TABLE `products` (
  ...
  `productdescription` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `productcatagory` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
